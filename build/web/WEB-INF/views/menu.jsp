...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="charts.html"><i class="fa fa-fw fa-user"></i> Usuários</a>
            </li>
            <li>
                <a href="tables.html"><i class="fa fa-fw fa-users"></i> Requerentes</a>
            </li>
            <li>
                <a href="forms.html"><i class="fa fa-fw fa-ambulance"></i> Ocorrências</a>
            </li>
            <li>
                <a href="bootstrap-elements.html"><i class="fa fa-fw fa-folder"></i> Protocolos</a>
            </li>
            <li>
