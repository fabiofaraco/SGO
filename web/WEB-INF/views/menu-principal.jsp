...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/usuario/lista"><i class="fa fa-fw fa-user"></i> Usuários</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/requerente/lista"><i class="fa fa-fw fa-users"></i> Requerentes</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/ocorrencia/lista"><i class="fa fa-fw fa-ambulance"></i> Ocorrências</a>
            </li>
            <li>
